...
// FIX: Pake interface ini biar nggak error 'declared but never used'
...
export default function HampersBuilder({ setCartCount }: HampersBuilderProps) {
  ...
  const handleHampersWA = () => {
    // FIX: Gunakan setCartCount biar peringatan 'value is never read' ilang
                  ...
                  <motion.div key="finish-mode" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="bg-[#FAF5E9] rounded-[3rem] p-8 border-4 border-[#4A3022] shadow-[8px_8px_0px_#4A3022] relative overflow-hidden">
                    ...
                    <div className="bg-white border-4 border-[#4A3022] rounded-2xl p-6 mb-8 relative z-10 shadow-[4px_4px_0px_#4A3022]">
                      ...
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="font-jakarta font-black text-[#4A3022] text-lg">Rp {currentTotal.toLocaleString('id-ID')}</span>
                      </div>
                    ...
                    <div className="space-y-4 relative z-10">
                      <motion.button onClick={handleHampersWA} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.95 }} className="w-full text-white bg-[#D97736] py-4 border-4 border-[#4A3022] rounded-2xl font-jakarta font-black text-lg flex items-center justify-center gap-2 shadow-[4px_4px_0px_#4A3022]">
      ...
      <section className="py-24 bg-[#F7F3EB] px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-playfair font-black text-[#4A3022] mb-4">Cara Kerja Hampers Custom</h2>
            <p className="text-lg font-jakarta font-bold text-[#4A3022]/80">Proses mudah, cepat, dan transparan.</p>
          </div>
