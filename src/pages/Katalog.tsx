...
export default function Katalog({ addToCart }: KatalogProps) {
  ...
  const carouselProducts: Product[] = [
    { 
      ...
      category: "Cookies", 
      price: 70000, 
      desc: "Cookies nastar lumer dengan isian nanas asli buatan sendiri. Best seller nomor 1 Oriena!", 
      badge: "BEST SELLER", 
      image: FotoNastar 
    },
    { 
      ...
      category: "Bakery", 
      price: 45000, 
      desc: "Roti sisir klasik yang super lembut dengan olesan mentega manis yang pas di lidah.", 
      badge: "FAVORIT", 
      image: "https://github.com/user-attachments/assets/f075d205-bb78-42c1-8466-ef803038a700" 
    },
    { 
      id: 3, 
      name: "Sustik (Sus Kering)", 
      category: "Snack", 
      price: 15000, 
      desc: "Cemilan sus kering gurih yang renyah banget. Pas buat nemenin nugas atau ngantor.", 
      badge: "RENYAH", 
      image: "https://github.com/user-attachments/assets/b8e267a8-d73f-401d-8ddc-bef625f21d9d" 
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative w-full max-w-md">
            <Search 
              className="absolute left-4 top-1/2 -translate-y-1/2 text-[#4A3022]" 
              size={24} 
              strokeWidth={3} 
            />
            <input 
        ...
        {/* ==========================================
        // SECTION: MOMEN / SOCIAL PROOF
        // ========================================== */}
        <div className="mb-24">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 bg-[#4A3022] border-2 border-[#4A3022] rounded-xl flex items-center justify-center text-[#FAF5E9] shadow-[4px_4px_0px_#D97736]">
              <Heart size={24} />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 md:bottom-8 md:left-8 md:right-8 z-10">
                <motion.div 
                  className="bg-white/95 backdrop-blur-sm border-4 border-[#4A3022] p-5 md:p-6 rounded-3xl shadow-[6px_6px_0px_#4A3022] group-hover:-translate-y-2 transition-transform duration-500"
                >
                  <h3 className="text-2xl font-playfair font-black text-[#4A3022] mb-1 md:mb-2">
                    Teman Kopi Pagimu.
                  </h3>
                  <p className="text-[#4A3022]/80 font-jakarta font-bold text-xs md:text-sm">
                    Manisnya roti sisir dan secangkir kopi hangat bikin beban kerja atau nugas numpuk jadi kerasa lebih ringan.
                  </p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 md:bottom-8 md:left-8 md:right-8 z-10">
                ...
                >
                  ...
                  <p className="text-[#4A3022]/80 font-jakarta font-bold text-xs md:text-sm">
                    Kirim kehangatan oven kami untuk orang tersayang. Pas banget buat rayain ulang tahun atau hari raya spesial.
                  </p>
                </motion.div>
              </div>
            </motion.div>
        ...
        {/* ==========================================
        // SECTION: CAROUSEL KOLEKSI UNGGULAN
        // ========================================== */}
          ...
          <div className="mb-24">
            ...
            <div className="relative w-full h-[450px] md:h-[550px] rounded-[2rem] border-4 border-[#4A3022] shadow-[12px_12px_0px_#4A3022] overflow-hidden bg-[#E0D0BB]">
              <AnimatePresence initial={false}>
                ...
                >
                  <img 
                    src={filteredCarousel[carouselIndex].image} 
                    alt={filteredCarousel[carouselIndex].name} 
              ...
              <div className="absolute bottom-8 right-8 z-30 flex gap-2">
                {filteredCarousel.map((_, idx) => (
                  <button 
                    ...
                    className={`h-3 rounded-full border-2 border-[#4A3022] shadow-[2px_2px_0px_#4A3022] transition-all duration-300 ${
                      carouselIndex === idx 
                        ? 'w-10 bg-[#D97736]' 
                        : 'w-3 bg-[#FAF5E9]'
                    }`}
                ...
                {filteredAll.map((product) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-1 px-1">
                      <p className="text-[#829079] text-[10px] font-jakarta font-black uppercase tracking-wider mb-1">
                        {product.category}
                      </p>
                      <h4 className="font-playfair font-black text-[#4A3022] mb-1 line-clamp-2 leading-tight text-sm md:text-base">
                        {product.name}
                      </h4>
                      <span className="text-[#D97736] font-jakarta font-black text-sm mt-auto mb-3">
        ...
        {/* ==========================================
        // SECTION: JIKA KOSONG (EMPTY STATE)
        // ========================================== */}
        {filteredCarousel.length === 0 && filteredAll.length === 0 && (
          <div className="text-center py-24 bg-white border-4 border-[#4A3022] rounded-3xl shadow-[8px_8px_0px_#4A3022]">
            ...
            <h3 className="text-2xl font-playfair font-black text-[#4A3022] mb-2">
              Waduh, kuenya nggak ketemu!
            </h3>
            <p className="text-[#4A3022]/60 font-jakarta font-bold">
              Coba cari pakai kata kunci lain atau reset filter.
            </p>
          </div>
        )}
        ...
        <AnimatePresence>
          {selectedProduct && (
            <motion.div 
              ...
              animate={{ opacity: 1 }} 
              exit={{ opacity: 0 }} 
              className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#4A3022]/80 backdrop-blur-sm" 
            ...
            >
              <motion.div 
                ...
                animate={{ scale: 1, y: 0 }} 
                exit={{ scale: 0.9, y: 50 }} 
                className="bg-[#FAF5E9] w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-[2rem] border-4 border-[#4A3022] flex flex-col md:flex-row shadow-[12px_12px_0px_#D97736] relative custom-scrollbar" 
                onClick={(e) => e.stopPropagation()}
              >
                
                <button 
                  onClick={() => setSelectedProduct(null)} 
                  className="absolute top-4 right-4 p-2 bg-white border-4 border-[#4A3022] text-[#4A3022] rounded-xl hover:bg-[#D97736] hover:text-white transition-all z-30 shadow-[4px_4px_0px_#4A3022] active:translate-y-1 active:shadow-none"
                >
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center font-jakarta bg-[#FAF5E9]">
                  ...
                  <h2 className="text-3xl md:text-5xl font-playfair font-black text-[#4A3022] mb-4">
                    {selectedProduct.name}
                  </h2>
                  <p className="text-[#4A3022]/80 mb-8 font-bold text-base leading-relaxed">
